...
class RefundConsoleCommand extends Console
{
    const COMMAND_NAME = 'adyen-api:test:refund';
    ...
    protected function configure()
    {
        ...
        $this->setDescription('AdyenApi Test Facade methods refund');
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $response = $app->performRefundApiCall($this->createRequestTransfer());
